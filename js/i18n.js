const translations = {
    'zh-TW': {
        ...
        openSettings: '開啟設定',
        openTextFile: '開啟文字檔',
        dropzoneHint: '將檔案拖曳至此，或自雲端載入',
        btnSelectLocal: '選擇本機檔案',
        ...
        settingMarginTop: "上邊距",
        settingMarginBottom: "下邊距",
        settingMarginLeft: "左邊距",
        settingMarginRight: "右邊距",
        settingTTS: "TTS 語音設定",
        ...
        gdriveFetchFail: '讀取檔案清單失敗！',
        gdrivePickerTitle: '選擇雲端硬碟檔案',
        gdriveCancel: '取消',
        gdriveDownloading: '正在下載 {0}...',
        gdriveZipDev: '已下載 ZIP，但解壓縮 (.zip) 引擎仍在開發中！',
        gdriveDownloadFail: '檔案下載失敗！'
    },
    'zh-CN': {
        appTitle: 'Zen Reader',
        ...
        openSettings: '打开设置',
        openTextFile: '打开文本文件',
        dropzoneHint: '将文件拖拽至此，或自云端载入',
        btnSelectLocal: '选择本地文件',
        ...
        dirHorizontal: '横排',
        dirVertical: '竖排',
        settingFontFamily: '字体风格',
        settingLoadLocalFont: '从本地载入更多字体...',
        fontSans: '无衬线体 (默认黑体)',
        fontSerif: '衬线体 (明体/宋体)',
        fontMono: '等宽字体',
        settingFontSize: '字体大小: ',
        settingLineHeight: '行距: ',
        settingMargins: '边距设置 (Pixels)',
        settingMarginTop: '上边距',
        settingMarginBottom: '下边距',
        settingMarginLeft: '左边距',
        settingMarginRight: '右边距',
        settingTTS: 'TTS 语音设置',
        settingTTSModel: '语音引擎与模型',
        settingTTSSpeed: '语音速度',
        ...
        btnGoogleLogin: '登录 Google 账号',
        btnOpenReadingLog: '打开 Reading Log 编辑',
        clearCache: '清除所有缓存 (Clear Cache)',
        ...
        gdriveFetchFail: '读取文件列表失败！',
        gdrivePickerTitle: '选择云端硬盘文件',
        gdriveCancel: '取消',
        gdriveDownloading: '正在下载 {0}...',
        gdriveZipDev: '已下载 ZIP，但解压缩 (.zip) 引擎仍在开发中！',
        gdriveDownloadFail: '文件下载失败！'
    },
    'en-US': {
        appTitle: 'Zen Reader',
        ...
        dropzoneHint: 'Drop a file here, or load from cloud',
        ...
        themeLight: 'Light',
        themeDark: 'Dark',
        settingDirection: 'Reading Direction',
        dirHorizontal: 'Horizontal',
        dirVertical: 'Vertical',
        settingFontFamily: 'Font Family',
        settingLoadLocalFont: 'Load more fonts from local device...',
        fontSans: 'Sans-Serif',
        fontSerif: 'Serif',
        fontMono: 'Monospace',
        settingFontSize: 'Font Size: ',
        settingLineHeight: 'Line Height: ',
        settingMargins: 'Margins (Pixels)',
        settingMarginTop: 'Top Margin',
        settingMarginBottom: 'Bottom Margin',
        settingMarginLeft: 'Left Margin',
        settingMarginRight: 'Right Margin',
        settingTTS: 'TTS Voice Settings',
        settingTTSModel: 'TTS Engine & Model',
        settingTTSSpeed: 'Speech Rate',
        ...
        btnOpenReadingLog: 'Open Reading Log Editor',
        ...
        gdriveFetchFail: 'Failed to fetch file list!',
        gdrivePickerTitle: 'Select Cloud File',
        gdriveCancel: 'Cancel',
        gdriveDownloading: 'Downloading {0}...',
        gdriveZipDev: 'ZIP downloaded, but extraction engine is currently in development!',
        gdriveDownloadFail: 'File download failed!'
    },
    'ja-JP': {
        appTitle: 'Zen Reader',
        ...
        themeLight: 'ライト',
        themeDark: 'ダーク',
        settingDirection: 'テキストの方向',
        dirHorizontal: '横書き',
        dirVertical: '縦書き',
        settingFontFamily: 'フォント',
        settingLoadLocalFont: 'ローカルからフォントを読み込む...',
        fontSans: 'ゴシック体',
        fontSerif: '明朝体',
        fontMono: '等幅フォント',
        settingFontSize: 'フォントサイズ: ',
        settingLineHeight: '行間: ',
        settingMargins: '余白設定 (Pixels)',
        settingMarginTop: '上余白',
        settingMarginBottom: '下余白',
        settingMarginLeft: '左余白',
        settingMarginRight: '右余白',
        settingTTS: 'TTS 音声設定',
        settingTTSModel: '音声エンジンと言語モデル',
        settingTTSSpeed: '読み上げ速度',
        ...
        btnGoogleLogin: 'Google アカウントでログイン',
        btnOpenReadingLog: 'Reading Log 編集を開く',
        clearCache: 'すべてのキャッシュをクリア (Clear Cache)',
        ...
        gdriveFetchFail: 'ファイルリストの取得に失敗しました！',
        gdrivePickerTitle: 'クラウドファイルを選択',
        gdriveCancel: 'キャンセル',
        gdriveDownloading: '{0} をダウンロード中...',
        gdriveZipDev: 'ZIPをダウンロードしましたが、解凍エンジンは現在開発中です！',
        gdriveDownloadFail: 'ファイルのダウンロードに失敗しました！'
    }
};
